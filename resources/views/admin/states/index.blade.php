                        ...
                        <div class="portlet-title">
                            ...
                            <div class="actions">
                                <div class="btn-group pull-right">
                                    <a href="{{route('states.create')}}" class="btn sbold green">Add
                            ...
                            <table class="table table-striped table-bordered table-hover table-checkable order-column"
                                ...
                                @foreach($states as $state)
                                    <tr class="odd gradeX">
                                        ...
                                        <td class="center">{{$state->country_name}}</td>
                                        <td class="center">{{$state->created_at}}</td>
                                        <td>
                                            <form style="float:right;" method="POST" class="form-inline" action="{{route('states.destroy', $state->state_id)}}" onsubmit="return confirm('Are you sure?')">
                                                {{method_field('DELETE')}}
                                                {{csrf_field()}}
                                                <a href="{{ route('states.edit', $state->state_id) }}"
