                            ...
                            <div class="form-body">
                                <div class="form-group">
                                    <div class="col-md-12">
                                        ...
                                        @if ($errors->has('title'))<span
                                                class="help-block">{{ $errors->first('title') }}</span>@endif
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-12">
                                        ...
                                        <textarea class="wysihtml5 form-control" name="description" rows="6"
                                                  placeholder="Events Body" required
                                ...
                                <div class="form-group">
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" class="form-control" name="last_registration_date" required
                                               autofocus id="last_registration_date" value="">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        ...
                                        <label class="radio-inline">
                                            <input type="radio" name="fixed_amount" id="fixed_amount" value="1" checked>
                                            Yes
                                        </label>
                                        <label class="radio-inline">
                                ...
                                <div class="form-group">
                                    <div class="col-md-3">
                                        ...
                                        <br>
                                        <input type="text" class="form-control" name="guest_amount" autofocus
                                               id="guest_amount" value="">
                                    </div>
                                </div>
