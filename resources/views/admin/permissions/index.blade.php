                        ...
                        <div class="portlet-title">
                            ...
                            <div class="actions">
                                <div class="btn-group pull-right">
                                    <a href="{{route('permissions.create')}}" class="btn sbold green">Add
                                ...
                                @foreach($userPermissions as $role)
                                    <tr class="odd gradeX">
                                        ...
                                        <td>
                                            ...
                                            <form style="float:right;" method="POST" class="form-inline" action="{{route('permissions.destroy', $role->id)}}" onsubmit="return confirm('Are you sure?')">
                                                {{method_field('DELETE')}}
                                                {{csrf_field()}}
