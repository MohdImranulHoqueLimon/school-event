...
<div id="about">
    <div class="container">
        <div class="row">
           <div class="col-md-12">
               <div class="alert alert-success information-box" role="alert" style="margin-top: 30px;line-height: 25px;">Thank you for registration. Please login to complete  your account.</div>
           </div>
       </div>
   </div>
</div>
