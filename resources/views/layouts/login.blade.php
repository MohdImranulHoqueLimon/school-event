        ...
        <div class="content">
            ...
            <form name="login" role="form" method="POST"  class="login-form" action="{{ url('/login') }}" method="post" >
                ...
                <div class="form-actions">
                    ...
                    <button type="submit" class="btn btn-primary uppercase btn-block popupLoginBtn">Login</button>
                    <a href="javascript:;" id="forget-password" class="forget-password">Forgot Password?</a><br>
                </div>
                <div class="create-account-front">
                    <p>
                        <a href="javascript:;" id="register-btn" class="uppercase btn btn-danger btn-block popupLoginBtn">Create an account</a>
                    </p>
                </div>
            </form>
            ...
            <form class="forget-form" role="form" method="POST" action="{{ url('/password/email') }}">
                ...
                <div class="form-actions">
                    ...
                    <button type="submit" class="btn btn-success uppercase pull-right popupLoginBtn">Submit</button>
                </div>
            </form>

            <!-- END FORGOT PASSWORD FORM -->
            <!-- BEGIN REGISTRATION FORM -->
            <form class="register-form" name="registration" role="form" method="POST" action="{{ route('employees.store') }}">
                {{ csrf_field() }}
                ...
                <div class="form-group">
                    <input class="form-control placeholder-no-fix" type="text" placeholder="PO Box" name="po_box" />
                </div>
                <div class="form-group">
                ...
                <div class="form-actions">
                    ...
                    <button type="submit" id="register-submit-btn" class="btn btn-success uppercase pull-right popupLoginBtn">Submit</button>
                </div>
            </form>
...
<!-- login/registration/forgot password popup End-->
